...
ArrayList<Expense>expenses=(ArrayList<Expense>) ferService.getExpenses(Integer.parseInt(session.getAttribute("userId").toString()));
%>
ExpenseId:
...
<input type="button" value="Edit Expense"
	onclick="submitForm('EditExpense.jsp')">
